...
{
    public partial class admiMain : Form
    {
        string[] information;
        OracleConnection conn;
        public admiMain(string[] information, OracleConnection conn)
        {
            InitializeComponent();
            this.conn = conn;
        ...
        {
            addBook add = new addBook(conn);
            add.Visible = true;
        }

        private void button7_Click(object sender, EventArgs e)
        {
            book_change b = new book_change(conn);
            b.Visible = true;
        }

        private void button5_Click(object sender, EventArgs e)
        {
            defalutmanager de = new defalutmanager(conn);
            de.Visible = true;
        }
    }
}
